...
public class GameView extends BoardView {
	...
	private int HelpMF = 3;
	private int HelpXN = 2;
	...
	public static final int ID_SOUND_TIPMF = 7;
	public static final int ID_SOUND_TIPXN = 8;
	public static final int ID_SOUND_ERROR = 9;
	...
	public void startPlay(){
		...
		toolsChangedListener.onTipMFChanged(HelpMF);
		toolsChangedListener.onTipXNChanged(HelpXN);
	...
	public static void initSound(Context context){
		 soundPlay = new SoundPlay();
	        ...
	        soundPlay.loadSfx(context, R.raw.item2, ID_SOUND_TIPMF);
	        soundPlay.loadSfx(context, R.raw.item2, ID_SOUND_TIPXN);
	...
	public int getTipMFNum(){
		return HelpMF;
	}
	
	public int getTipXNNum(){
		return HelpXN;
	}
	...
	public void autoClearMF() {
		if (HelpMF == 0) {
			soundPlay.play(ID_SOUND_ERROR, 0);
		}else{
			soundPlay.play(ID_SOUND_TIPMF, 0);
			HelpMF--;
			toolsChangedListener.onTipMFChanged(HelpMF);
			drawLine(path.toArray(new Point[] {}));
			refreshHandler.sleep(500);
	...
	public void autoClearXN() {
		if (HelpXN == 0) {
			soundPlay.play(ID_SOUND_ERROR, 0);
		}else{
			soundPlay.play(ID_SOUND_TIPXN, 0);
			HelpXN--;
			toolsChangedListener.onTipXNChanged(HelpXN);
			drawLine(path.toArray(new Point[] {}));
			refreshHandler.sleep(500);
